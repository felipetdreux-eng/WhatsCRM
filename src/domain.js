...
export function buildDemoLeads(baseDate = new Date()) {
  return [
    ...
    { id: '9', name: 'Oficina JM', company: 'Oficina mecânica', phone: '21999999999', value: 850, status: 'Negociação', origin: 'Google Maps', nextContact: dateKeyOffset(3, baseDate), nextContactTime: '09:30', nextAction: 'Fazer follow-up', notes: '', createdAt: isoOffset(-6, 18, baseDate) },
    { id: '10', name: 'Personal Lucas', company: 'Personal trainer', phone: '21999999980', value: 650, saleValue: 600, status: 'Fechado', origin: 'Indicação', nextContact: '', nextContactTime: '', nextAction: '', notes: 'Cliente ativo.', createdAt: isoOffset(-7, 14, baseDate), soldAt: isoOffset(-2, 16, baseDate) },
    { id: '11', name: 'Restaurante Sabor', company: 'Restaurante', phone: '21999999981', value: 700, saleValue: 700, status: 'Fechado', origin: 'Site', nextContact: '', nextContactTime: '', nextAction: '', notes: 'Cliente ativo.', createdAt: isoOffset(-8, 15, baseDate), soldAt: isoOffset(-3, 16, baseDate) },
